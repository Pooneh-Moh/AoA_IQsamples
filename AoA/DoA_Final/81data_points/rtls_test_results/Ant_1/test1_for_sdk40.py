...
new_data = pd.read_csv('rtls_test_results/Ant_1/03_26_2021_14_28_20_rtls_raw_iq_samples_f88a5e2d7808_0.csv')
ant_1 = []
ant_2 = []
ant_3 = []
ant_4 = []
...
for n in range(N):
    ...
    result.to_csv('Average_phase_per_pkt_ant1_15.csv', index=False)
npa_ang_final = (np.average(phi_1)+ np.average(phi_2) + np.average(phi_3) + np.average(phi_4))*0.25
...
angle.to_csv('Final_ave_total_ant1_15.csv', index=False)
